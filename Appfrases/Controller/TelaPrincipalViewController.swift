...
class TelaPrincipalViewController: UIViewController {
    ...
    func validaFelicidade() {
        ...
        let frasesFeliz: [String] = ["Pensamentos felizes geram sentimentos felizes, que, consequentemente, afetam a sua disposição e o seu humor, então escolha pensar positivo.","frase feliz 2","frase feliz 3","frase feliz 4"]
       
        let frasesTriste: [String] = ["Há um mundo lá fora esperando por você. Há um céu infinito esperando para ser descoberto, esperando que você voe nele. ", "frase triste 2", "frase triste 3", "frase triste 4"]
        
        let frasesCansado: [String] = ["O sucesso nasce do querer, da determinação e persistência em se chegar a um objetivo. Mesmo não atingindo o alvo, quem busca e vence obstáculos, no mínimo fará coisas admiráveis\n – José de Alencar", "Se você quer ser bem-sucedido precisa de dedicação total, buscar seu último limite e dar o melhor de si mesmo.\n – Ayrton Senna", "Não crie limites para si mesmo. Você deve ir tão longe quanto sua mente permitir. O que você mais quer pode ser conquistado\n – Mary Kay Ash", "Todos os dias, pela manhã, você tem duas opções: apertar o botão de soneca e continuar sonhando ou levantar-se para começar a transformar os seus sonhos em realidade."]
        ...
        let frasesExausto: [String] = ["Não desista! Faça acontecer e deixe todos que não acreditaram em você de queixo caído!", "Todos os dias, pela manhã, você tem duas opções: apertar o botão de soneca e continuar sonhando ou levantar-se para começar a transformar os seus sonhos em realidade.", "3"]
